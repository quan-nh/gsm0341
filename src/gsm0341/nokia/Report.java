...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "Report", isSet = false )
    public class Report implements IASN1PreparedElement {
            @ASN1Integer( name = "" )
	...
	private Integer messageIdentifier = null;
        ...
        @ASN1Element ( name = "serialNumber", isOptional =  false , hasTag =  true, tag = 1 , hasDefaultValue =  false  )
...
@ASN1SequenceOf( name = "failureList", isSetOf = false ) 
	...
	private Channel channelIndicator = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Report.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
